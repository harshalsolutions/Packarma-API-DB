...
export const getAllUserSubscriptionsController = async (req, res, next) => {
    try {
        ...
        const [subscriptions] = await pool.query(`
            SELECT us.user_id, us.subscription_id, us.start_date, us.end_date, s.type AS subscription_name, si.total_price, si.currency, si.invoice_link, si.invoice_date, si.transaction_id, si.createdAt, si.updatedAt, u.firstname, u.lastname, u.email
